...
module SharedStorage
  ...
  #
  class Postgres < SharedStorage::Base
    ...
    def read
      ...
      result = Utils::Postgres::Request.execute(params)

      first_result = result.first

      Types::Read.new(first_result[:id], first_result[:data], first_result[:inserted_at])
    end
